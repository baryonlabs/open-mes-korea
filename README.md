...
- [기능 요구사항 및 오픈소스 분석](docs/requirements-and-open-source-analysis.md)
- [IoT 연결부 오픈소스 전략](docs/iot-connectivity-open-source-strategy.md)
- [제조사 도입 검토 가이드](docs/adoption/README.md)
- [로드맵](docs/roadmap.md)
